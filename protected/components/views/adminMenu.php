...
<ul>
    ...
    <li><?php echo CHtml::link('Manage Indices Assignments',array('rating2indices/admin')); ?></li>
    ...
    <li><?php echo CHtml::link('Manage User Assignments',array('teachers2departments/admin')); ?></li>
